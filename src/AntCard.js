  ...
  <div class="second-container">
    <div class="col--2">
      <div class="first-column">
        <p class="first-column-p">Your Result</p>
        ...
        <div class="great">
          <h2>Great</h2>
          <p class="first-column-report">You scored higher than 65% of the people who have taken these tests.</p>
        </div>
      </div>
      <div class="second-column">
        <p class="second-column-summary">Summary</p>
        <ul>
          <li class="li-one">
            <div class="inside-flex-one">
